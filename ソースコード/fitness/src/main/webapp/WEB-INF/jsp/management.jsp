...
String daily_data=(String)request.getAttribute("daily_data");
String target_data=(String)request.getAttribute("target_data");
	%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container text-center my-4">
		...
		<div class="row mt-2 justify-content-center">
			<c:if test="${ not empty labels && not empty daily_data}"><canvas id="myLineChart"></canvas>
